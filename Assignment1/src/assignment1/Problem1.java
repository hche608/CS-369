...
public class Problem1 {
	...
	public static void main(String[] args) throws IOException {
        ...
        final int[][] imageU = MatrixUtils.MatrixDouble2Int(U.getArray(), new MatrixUtils.LinearMap(MatrixUtils.min(U.getArray()), MatrixUtils.max(U.getArray())));
        PGMIO.write(imageU, new File(svdDir, "U.pgm"));
		
		//printMatrix(U);
		
        final Matrix D = SVD.getS();
        final int[][] imageD = MatrixUtils.MatrixDouble2Int(D.getArray(), new MatrixUtils.LinearMap(MatrixUtils.min(D.getArray()), MatrixUtils.max(D.getArray())));
        ...
        final int[][] imageV = MatrixUtils.MatrixDouble2Int(V.getArray(), new MatrixUtils.LinearMap(MatrixUtils.min(V.getArray()), MatrixUtils.max(V.getArray())));
